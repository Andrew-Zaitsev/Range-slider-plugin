...
;// CONCATENATED MODULE: ./control-panel/control-panel.ts
...
class ControlPanel {
    constructor(parentElem, demoSliderElem) {
        ...
        this.scaleDivisionsNumberInput = document.createElement('input');
    ...
    handleMinValueInputChange() {
        const newMinValue = +(this.minValueInput.value);
...
__decorate([
    bind_decorator/* default */.ZP
], ControlPanel.prototype, "handleMinValueInputChange", null);
__decorate([
    bind_decorator/* default */.ZP
...
class DemoSliderInit {
    constructor(demoSliderOptions) {
        ...
        this.demoSliderWrapperForControlPanel = document.createElement('div');
        this.demoSliderControlPanel = document.createElement('div');
...
/******/ __webpack_require__.O(0, [982], () => (__webpack_exec__(399)));
